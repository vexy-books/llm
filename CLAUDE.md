...
## Project: The Vexy Book of LLMs

This is a technical book project. Key resources:

### Essential Files
- `README.md` - Project overview
- `PLAN.md` - Book structure and meta-planning
- `TODO.md` - Active task list with phases

### Source Material (private/)
- `private/private6.txt` - **THE MAP**: Master index of 1,500+ paths with TLDRs
- `private/private2/` - File-by-file TLDRs (read these first)
- `private/private/` - Full source material (read selectively)

### .claude Scaffolding
- `.claude/agents/chapter-writer.md` - Chapter writing agent
- `.claude/agents/source-analyzer.md` - Source analysis agent
- `.claude/agents/prose-reviewer.md` - Prose review agent
- `.claude/skills/technical-writing.md` - Writing guidelines
- `.claude/skills/source-reading.md` - Source reading strategy
- `.claude/commands/write-chapter.md` - Chapter writing workflow
- `.claude/commands/survey-sources.md` - Source survey workflow

### Book Output
- `src_docs/md/` - Markdown chapters (source)
- `docs/` - Built site (Zensical output)
- `zensical.toml` - Site configuration

### Writing Workflow
1. Survey sources with `/survey-sources [topic]`
2. Write chapters with `/write-chapter [number]`
3. Build: `zensical build --clean`
4. Preview: `zensical serve`
