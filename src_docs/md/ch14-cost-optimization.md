...
> **2025 Update**: API pricing has dropped significantly. Claude 3.5/3.7 Haiku now costs $0.25/$1.25 per 1M tokens (input/output). GPT-4o Mini runs at $0.60/$2.40 per 1M. Gemini 2.5 Flash is even cheaper at $0.015/$0.06 per 100K tokens. Batch processing discounts (50% off at Anthropic and OpenAI) make non-urgent workloads much cheaper. The optimization strategies below remain valid—but the baseline costs have improved dramatically.
...
| Google | Gemini 3 Pro (<200K) | $2.00 | $12.00 |
